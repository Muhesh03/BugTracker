...
selectedStatus: any = null;
 ...
 this.loadLiveticketStatuses() ;
  ...
  loadLatestTicketNumber() {
    this.liveticketservice.getLatestTicketNumber()
      .subscribe(res => {
        console.log("laaaaaaaaaaaaaaatest ticket number", res.data.ticket_number);
...
export class LiveTicketUpdateFormComponent implements OnInit {
  ...
  imageBaseUrl = 'enviroment.ServerApi/uploads/';
  today = new Date();
