        ...
        next: (rows: any[] |null) => {
          ...
          rows.forEach(p => {
            ...
            switch (p.page_name) {
              ...
              case 'clientTicketView': this.otherpermissions.clientTicketView = p.permission; break;
            }
          });
        },
        error: (err) => {
  ...
  save() {
    const payload = {
      ...
      permissions: [
        ...
        { page_name: 'clientTicketView', permission: this.otherpermissions.clientTicketView }
      ]
    };
